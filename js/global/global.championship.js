...
/*
  function renderPlayers(players) {
      ...
      for (let i = players.length - 1; i >= 0; i--) {
          if (i !== 0) {
              playersHtml += `
                  <div class="championship__players--second-fifth">
                    <div class="championship__player">
                      <div>
                        <img
                          class="championship__player-img"
                      ...
                      <div class="championship__player-details">
                        <div class="championship__player-details--name-point">
                          <p class="championship__player-name">${players[i].name}</p>
                          <p class="championship__player-separator"></p>
                          <p class="championship__player-point">${players[i].point}</p>
                        </div>
                        <div>
                          <p class="championship__player-place">${players[i].place}</p>
                        </div>
                      </div>
                    </div>
                  </div>`;
              ...
              playersHtml += `
              <div class="championship__player--first">
              <svg class="championship__player--first__crone"
                   xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 90 90" xml:space="preserve"
              ...
              <div>
                <p class="championship__player-name--first">${players[i].name}</p>
                <p class="championship__player-place">${players[i].place}</p>
                <p class="championship__player-point--first">${players[i].point}</p>
                <p class="championship__player-rating">Rating</p>
              </div>
            </div>`;
          }
      }  
      document.querySelector(".championship__players").innerHTML = playersHtml;
  }
